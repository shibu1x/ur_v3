...
var (
	roomDBTypes = map[string]string{`ID`: `bigint`, `HouseCode`: `character varying`, `RoomCode`: `character varying`, `Status`: `character varying`, `GotAt`: `timestamp without time zone`, `Data`: `json`, `Price`: `integer`, `Fee`: `integer`, `Type`: `character varying`, `Space`: `integer`, `Floor`: `integer`, `LayoutURL`: `character varying`, `URL`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
